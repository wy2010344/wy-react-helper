...
import {
  ...
  GetRef,
  TriggerMConfig,
  effectCssAinmationFirst,
  effectCssAnimationOther,
} from 'wy-dom-helper';
/**
...
>(ref: GetRef<T>, render: (deps: Dep) => TriggerMConfig<T, M>, deps: Dep) {
...
export function useTriggerStyleInit<
  T extends ElementCSSInlineStyle & Element,
  M extends ClsWithStyle,
>(ref: GetRef<T>, init: TriggerMConfig<T, M>) {
  useEffect(() => {
